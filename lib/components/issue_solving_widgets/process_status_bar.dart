...
class _ProcessStatusBarState extends State<ProcessStatusBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final issue = issueBloc.focusedIssue;
    ...
    return StreamBuilder<List<Hypothesis>>(
      ...
      builder: (context, hypothesesSnapshot) {
        ...
        return StreamBuilder<List<Solution>>(
          stream: issueBloc.solutionsStream,
                    ...
                    children: [
                      Expanded(
                        child: Row(
                          ...
                          children:
                              List.generate(processStages.length, (index) {
                            final stage = processStages[index];
                            final currentStage = (context
                                    .read<IssueBloc>()
                                    .state as IssueProcessState)
                                .stage;
                            ...
                            switch (stage) {
                              ...
                              case IssueProcessStage.narrowingToRootCause:
                                hasConflict =
                                    perspective.numberOfHypothesesInConflict() >
                                        0;
                                isDisabled = false;
                              ...
                              case IssueProcessStage.narrowingToSolve:
                                hasConflict =
                                    perspective.numberOfSolutionsInConflict() >
                                        0;
